class Admin::WorkshopsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @workshop.save
        format.html { redirect_to admin_workshop_path(@workshop), notice: 'Workshop was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @workshop.update_attributes(params[:workshop])
        format.html { redirect_to admin_workshop_path(@workshop), notice: 'Workshop was successfully updated.' }
