...
class WorkshopsControllerTest < ActionController::TestCase
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post :create, workshop: { description: @workshop.description, name: @workshop.name, nav_setting: @workshop.nav_setting }
    end
  ...
  test "should update workshop" do
    put :update, id: @workshop, workshop: { description: @workshop.description, name: @workshop.name, nav_setting: @workshop.nav_setting }
    assert_redirected_to workshop_path(assigns(:workshop))
  end
